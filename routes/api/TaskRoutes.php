...
Route::prefix('task')->group(function () {
    Route::post('/', [TaskController::class, 'store'])->middleware('auth:api', 'role:manager');
    ...
    Route::post('/{id}/children', [TaskController::class, 'addChild'])->middleware('auth:api', 'role:manager');
    Route::delete('/children/{childId}', [TaskController::class, 'removeChild'])->middleware('auth:api', 'role:manager');
});
